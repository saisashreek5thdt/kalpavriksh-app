...
const AccesTab = () => {
  return (
    <>
      ...
      <div className="my-10">
        <tables className="tables__Container">
          <thead className="tables__Head">
            <tr>
              <th className="tables__Head--Text">
                Sl No.
              </th>
              <th className="tables__Head--Text">
                Employee Name
          ...
          <tbody>
            <tr className="tables__Body--Row">
              <td className="tables__Body--Row_Data">
                1
              </td>
              <td className="tables__Body--Row_Data">
                Dr. Rajiv Singla
              ...
              <td className="tables__Body--Row_Data">
                <FiEdit className="tables__Body--Status_Icons" data-bs-toggle="modal" data-bs-target="#createEmployee" />
              </td>
            </tr>
            <tr className="tables__Body--Row">
              <td className="tables__Body--Row_Data">
