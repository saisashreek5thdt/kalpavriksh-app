      ...
      <div className="p-2" key={frm._id}>
        <div className="relative w-full overflow-hidden">
          ...
          <div className="bg-slate-50 shadow-lg h-12 w-full pl-5 rounded-md flex items-center">
            <h1 className="text-lg font-semibold text-gray-600">{frm.question_title}</h1>
          </div>
          {/* Down Arrow Icon */}
                  ...
                  <form action="#" method="POST">
                    <div className="form__Box-Shadow">
                      <div className="form__Box-Space">
                        ...
                        {frm.questions.filter((e)=>e.type === 'radio') &&  frm.questions.filter((e)=>e.type === 'checkbox') &&  frm.questions.map((qs)=>(
                          <>
