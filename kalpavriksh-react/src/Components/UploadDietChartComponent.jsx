          ...
          <div className="dietchart__column">
            <Formik
              initialValues={{
                lowerValue: "",
                upperValue: "",
                CarbohydrateslowerValue: "",
                CarbohydratesUpperValue: "",
                Protiens: "",
                Fats: "",
                VegNonVegEgg: "",
              }}
              validate={(values) => {
                ...
                if (!values.CarbohydrateslowerValue) {
                  errors.CarbohydrateslowerValue =
                    "Enter a valid CarbohydrateslowerValue";
                }
                if (!values.CarbohydratesUpperValue) {
                  errors.CarbohydratesUpperValue =
                    "Enter a valid CarbohydratesUpperValue";
                }
                if (!values.Protiens) {
                    ...
                    <div className="form__body">
                      ...
                      <div className="form__inputcontainer">
                        <Input
                          ...
                          input="text"
                          name="CarbohydrateslowerValue"
                          id="carbohydrates-upper-value"
                          onChange={handleChange}
                          onBlur={handleBlur}
                          value={values.CarbohydrateslowerValue}
                        />
                        <span className="form__span">
                          {errors.CarbohydrateslowerValue &&
                            touched.CarbohydrateslowerValue &&
                            errors.CarbohydrateslowerValue}
                        </span>
                        <Input
                          label="Carbohydrates Range (Upper Value)"
                          input="text"
                          name="CarbohydratesUpperValue"
                          id="carbohydrates-upper-value"
                          onChange={handleChange}
                          onBlur={handleBlur}
                          value={values.CarbohydratesUpperValue}
                        />
                        <span className="form__span">
                          {errors.CarbohydratesUpperValue &&
                            touched.CarbohydratesUpperValue &&
                            errors.CarbohydratesUpperValue}
                        </span>
                      </div>
                      ...
                      <div className="form__inputcontainer">
                        <Input
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          value={values.VegNonVegEgg}
                        />
                        <span className="form__span">
                          {errors.VegNonVegEgg &&
                            touched.VegNonVegEgg &&
                            errors.VegNonVegEgg}
                        </span>
