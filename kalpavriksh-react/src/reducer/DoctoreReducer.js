import { CREATE_FORM_FAIL, CREATE_FORM_REQUEST, CREATE_FORM_RESET, CREATE_FORM_SUCCESS, CREATE_PRESC_FAIL, CREATE_PRESC_REQUEST, CREATE_PRESC_RESET, CREATE_PRESC_SUCCESS, GET_APPOINTMENT_WITH_DATE_FAIL, GET_APPOINTMENT_WITH_DATE_REQUEST, GET_APPOINTMENT_WITH_DATE_SUCCESS, GET_DOCTOR_PROFILE_FAIL, GET_DOCTOR_PROFILE_REQUEST, GET_DOCTOR_PROFILE_SUCCESS, GET_PATIENT_OLDPRESC_FAIL, GET_PATIENT_OLDPRESC_REQUEST, GET_PATIENT_OLDPRESC_SUCCESS, UPDATE_PATIENT_FAIL, UPDATE_PATIENT_REQUEST, UPDATE_PATIENT_RESET, UPDATE_PATIENT_SUCCESS, UPLOAD_DIET_CHART_FAIL, UPLOAD_DIET_CHART_REQUEST, UPLOAD_DIET_CHART_RESET, UPLOAD_DIET_CHART_SUCCESS } from "../constant.js/DoctorConstant";
...
export const dietChartUploadReducer = (state = {}, action) => {
  ...
  export const prescriptionPatientReducer = (state = { loading:true,presc:[] }, action) => {
    switch (action.type) {
      case GET_PATIENT_OLDPRESC_REQUEST:
        return { loading: true };
      case GET_PATIENT_OLDPRESC_SUCCESS:
        return { loading: false, presc: action.payload.data };
      case GET_PATIENT_OLDPRESC_FAIL:
        return { loading: false, error: action.payload };
      default:
        return state;
    }
