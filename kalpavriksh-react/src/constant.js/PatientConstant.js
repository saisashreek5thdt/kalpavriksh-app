...
export const DOCTOR_SIGNOUT='DOCTOR_SIGNOUT'
...
export const CREATE_OBSERVATION_FAIL ='CREATE_OBSERVATION_FAIL'
export const CREATE_OBSERVATION_RESET ='CREATE_OBSERVATION_RESET'

export const GET_OBSERVATION_REQUEST ='GET_OBSERVATION_REQUEST'
export const GET_OBSERVATION_SUCCESS ='GET_OBSERVATION_SUCCESS'
export const GET_OBSERVATION_FAIL ='GET_OBSERVATION_FAIL'
...
export const GET_LATEST_PRESCRIPTION_REQUEST ='GET_LATEST_PRESCRIPTION_REQUEST'
export const GET_LATEST_PRESCRIPTION_SUCCESS ='GET_LATEST_PRESCRIPTION_SUCCESS'
export const GET_LATEST_PRESCRIPTIONT_FAIL ='GET_LATEST_PRESCRIPTION_FAIL'

export const GET_LATEST_DIET_CHART_REQUEST ='GET_LATEST_DIET_CHART_REQUEST'
export const GET_LATEST_DIET_CHART_SUCCESS ='GET_LATEST_DIET_CHART_SUCCESS'
export const GET_LATEST_DIET_CHART_FAIL ='GET_LATEST_DIET_CHART_FAIL'